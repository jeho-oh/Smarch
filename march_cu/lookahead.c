...
//#define DL_ITERATIONS	2 // should be higher on random
...
//                printf("c performing lookahead on %i\n", _treeNode.literal);
...
// 	while( 0 );  // appears better for CnC
 	while( lastChanged != 0 );
#endif
        return SAT;
}
